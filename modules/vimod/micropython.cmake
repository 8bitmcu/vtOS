...
# vimod_module.c's header comment for the full architecture. Modeled
...
# sites, this library force-includes vimod_compat.h (see that file's
...
add_library(usermod_vimod_neatvi_core STATIC
...
target_include_directories(usermod_vimod_neatvi_core PRIVATE
    ${CMAKE_CURRENT_LIST_DIR}
    ${CMAKE_CURRENT_LIST_DIR}/neatvi
)
target_compile_options(usermod_vimod_neatvi_core PRIVATE
    -include ${CMAKE_CURRENT_LIST_DIR}/vimod_compat.h
)
...
# malloc/realloc/free, so they must NOT get vimod_compat.h's
# substitution -- that's why they're a separate target from the STATIC
# library above rather than sharing its compile options.
add_library(usermod_vimod INTERFACE)
target_sources(usermod_vimod INTERFACE
    ${CMAKE_CURRENT_LIST_DIR}/vimod_module.c
    ${CMAKE_CURRENT_LIST_DIR}/vimod_term.c
    ${CMAKE_CURRENT_LIST_DIR}/vimod_vfs.c
    ${CMAKE_CURRENT_LIST_DIR}/vimod_compat.c
)

# Both this directory (vimod_module.h/vimod_vfs.h/vimod_compat.h) and
# neatvi/ (vi.h, #include "vi.h"'d by every vendored file via a plain ""
# include) need to be on the include path.
target_include_directories(usermod_vimod INTERFACE
    ${CMAKE_CURRENT_LIST_DIR}
    ${CMAKE_CURRENT_LIST_DIR}/neatvi
)
...
target_link_libraries(usermod_vimod INTERFACE usermod_vimod_neatvi_core)

# Link our INTERFACE library to the usermod target.
target_link_libraries(usermod INTERFACE usermod_vimod)
